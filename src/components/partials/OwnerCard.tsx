export const OwnerCard = () => {
    return(
        <div className="max-w-lg mx-auto my-10 bg-white rounded-lg shadow-md p-5">
            ...
            <h2 className="text-center text-2xl font-semibold mt-3">Sani Asmi R.L</h2>
            <p className="text-center text-gray-600 mt-1">Software Engineer</p>
            <div className="mt-5">
            <h3 className="text-xl font-semibold text-center">Bio</h3>
            <p className="text-gray-600 mt-2 text-center">John is a software engineer with over 10 years of experience in developing web and mobile applications. He is skilled in JavaScript, React, and Node.js.</p>
