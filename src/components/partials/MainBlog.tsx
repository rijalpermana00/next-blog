...
export const MainBlog = ({
  ...
  return (
    ...
    <div className='w-full max-w-md sm:max-w-5xl hover:shadow-2xl hover:translate-y-1 mx-auto transition ease-out delay-75 bg-white rounded-lg overflow-hidden shadow-md'>
